...
export default function PayOSReturnPage() {
  ...
  useEffect(() => {
    ...
    if (isSubscription) {
      // Redirect to vendor subscription page with success status
      navigate(`/vendor/subscription?payment=success`, {
        replace: true,
      });
      return;
    }
    ...
    if (user?.role === "Vendor") {
      navigate(`/vendor?payment=success&${location.search.slice(1)}`, {
        replace: true,
      });
      return;
    }
      ...
      try {
        ...
        if (id) {
          ...
          try {
            ...
            await clearCart();
            console.log(
              "[PayOS Return] ✅ Cart cleared after successful payment"
            );
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-50 rounded-lg p-6 text-center border border-blue-200">
                  ...
                  <p className="text-sm text-gray-600">
                    Đơn hàng đã được tạo và xác nhận
                  </p>
                </div>
                ...
                <div className="bg-purple-50 rounded-lg p-6 text-center border border-purple-200">
                  ...
                  <p className="text-sm text-gray-600">
                    Chi tiết đã được gửi đến email
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 p-6 mb-8 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center">
                    <span className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-sm mr-3 font-semibold">
                      1
                    </span>
                    <span>
                  ...
                  <li className="flex items-center">
                    ...
                    <span>
                      Đơn hàng sẽ được chuẩn bị và đóng gói trong 24 giờ
                    </span>
                  </li>
                  <li className="flex items-center">
                    <span className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-sm mr-3 font-semibold">
